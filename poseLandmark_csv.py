...
path_data_dir = "D:/Lemme measure ur pp/BKPM Semester 05/jurnal citra/CustomPose-Classification-Mediapipe-master/dataset" # args["dataset"]
path_to_save = "data_improved.csv" # args["save"]
...
for class_name in class_list:
    ...
    # Read each Images in the each classes
    for img in img_list:
